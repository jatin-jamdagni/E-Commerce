<template>
  <nav class="lg:border-b border-white">
    <div
      class="py-4 px-4 bg-black w-screen border-b border-white lg:border-none flex items-center justify-center space-x-3 md:space-x-12"
    >
      <!-- Logo Image -->
      <img
        src="../../../public/logo.png"
      ...
      <div class="flex items-center justify-center lg:space-x-8">
        ...
        <!-- Search Bar -->
        <div class="bg-black text-white flex items-center justify-center space-x-3 lg:space-x-10">
          ...
          <div>
            <button @click="router.push('/cart')">
              <svg
                ...
                height="24"
                width="28"
                class="bg-transparent fill-gray-400 active:fill-white hover:fill-white"
                viewBox="0 0 576 512"
              >
                <path
...
<!-- <div
class="flex flex-col-reverse md:flex-row lg:justify-center items-center lg:space-x-4 py-4 bg-primary w-auto"
>
...
<!-- <ul class="flex space-x-6 overflow-hidden bg-transparent text-typo">
...
<div class="flex justify-evenly space-x-6 bg-transparent">
  <div class="flex items-center relative bg-transparent">
    <input
      ...
      type="text"
      placeholder="Search.."
      class="bg-[#202327] py-2 px-4 pl-12 rounded-lg w-[60vw] text-[#6B240C] font-medium placeholder:text-secondary"
    />
    <label for="search" class="flex items-center bg-transparent">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        height="16"
        width="16"
