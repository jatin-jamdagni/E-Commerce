<template>
  <div class="p-6 flex flex-col md:flex-row">
    <div
      class="relative p-6 w-full md:h-[50%] overflow-hidden flex items-center justify-center md:w-[50%]"
    >
    ...
    <div class="p-6 space-y-2 md:w-[50%] flex flex-col justify-center">
      ...
      <div class="flex space-x-6">
        <h2 class="text-blue-500 font-semibold">Rating: &bigstar;{{ selectedProduct?.rating }}</h2>
      ...
      <div class="flex space-x-6">
        ...
        <h2 class="text-green-500 font-semibold">{{ selectedProduct?.discountPercentage }}% off</h2>
      </div>
